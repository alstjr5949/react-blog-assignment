import BlogDetailContents from "./BlogDetailContents";

export default {
  title: "Modules/ BlogDetailContents",
  components: BlogDetailContents,
};

const Template = (args) => <BlogDetailContents {...args} />;

export const BlogDetailContentsStory = Template.bind({});
BlogDetailContentsStory.args = {
  post: {
    id: 6,
